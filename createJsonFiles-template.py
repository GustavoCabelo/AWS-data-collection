...
scriptsPath =  "Update the python script to have the correct S3 locations for your Mapper.py and Reducer.py files - s3://xxxxxxxx/"
outputPath = "Update the python script to have the correct S3 address for your output bucket - s3://xxxxxxx/"
...
def getUserInputFile():
    file = raw_input("Enter input file (ex: name.bdf): ")
    return file

def getUserOutputFile():
    file = raw_input("Enter output file (dont add the .json extention) ")
    return file
